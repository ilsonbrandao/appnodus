...
function KanbanColumn({ id, title, leads, color }: { id: string, title: string, leads: Lead[], color: string }) {
...
function KanbanCard({ lead }: { lead: Lead }) {
    ...
    return (
        <div
            ...
            {...attributes}
            className={cn(
                "bg-white dark:bg-neutral-800 p-3 rounded-md shadow-sm border border-neutral-200 dark:border-neutral-700 cursor-grab hover:shadow-md transition-shadow select-none",
